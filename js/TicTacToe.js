...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the XIP.jpg is placed in HTML
            select.style.backgroundImage = 'url("images/XIP.jpg")';
            //Active player may only be 'X' ot 'O' so, if not 'X' it myst be 'O' 
        } else {
            //If activePlayer is equal to 'O', the OIP.jpg is placed in HTML
            select.style.backgroundImage = 'url("images/OIP.webp")';
        }
        //squareNumber and activePlayer are concatenated together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to check for any win conditions.
        checkWinConditions();
        //This condition is fot changing the active player.
        if (activePlayer === 'X') {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indivares where the start of a lines x axis is.
    let x1 = coordX1,
    ...
    function animateLineDrawing() {
        ...
        c.lineWidth = 10;
        //This metod sets the color of our line.
    ...
    animateLineDrawing();
    //This line waits 1 second. Then, clears canvas, resets game, an allows.
    setTimeout(function () { clear(); resetGame(); }, 1000);
}

//This function reset the game in the event of a tie or a win.
function resetGame() {
    //This for loop iterates through rach HTML swuare element.
    for (let i = 0; i < 9; i++) {
